...
class SnagsAndDefectsController extends BaseController
{
    // use HasComments;
    ...
    public function store(Request $request)
    {
        ...
        //     "Submitted new <a href='" . t_route('instructions.show', $instruction->id) ."'>Snag/Defect {$instruction->id}</a>", 
    ...
    {
        // Activity::add( replace with ::resource()
        //     "Updated <a href='" . t_route('instructions.show', $instruction->id) ."'>Snag/Defect {$instruction->id}</a>", 
        //     TestInspection::$activity_icon
        // );
        // Notification::add( replace with ::resource()
