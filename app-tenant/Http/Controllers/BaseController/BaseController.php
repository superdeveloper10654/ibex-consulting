...
class BaseController extends RoutingController
{
    ...
    /** @var object Model of the resource */
    protected $resource_model;

    public function __construct()
    {
        $this->resource_model = !empty($this->resource_model) ? $this->resource_model : BaseControllerHelper::determineResourceModel(static::class);
    }
