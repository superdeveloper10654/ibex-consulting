...
!(function (t) {
    ...
    function (t, e, i) {
        ...
        var c,
            h = i(4);
        t.exports = { copy: n, defined: a, mixin: r, uid: s, bind: o, event: l, eventRemove: d };
    },
    function (t, e) {
        function i(t) {
            var e = 0,
            ...
            return { y: Math.round(e), x: Math.round(i), width: t.offsetWidth, height: t.offsetHeight, right: Math.round(n), bottom: Math.round(r) };
        }
        function n(t) {
            var e = !1,
                i = !1;
        ...
        function o(t) {
            for (
                var e = t.querySelectorAll(["a[href]", "area[href]", "input", "select", "textarea", "button", "iframe", "object", "embed", "[tabindex]", "[contenteditable]"].join(", ")), i = Array.prototype.slice.call(e, 0), o = 0;
                o < i.length;
                o++
            ) {
                var l = i[o];
        ...
        function y(t, e) {
            ...
            var r = document.documentElement,
                n = { x: t.clientX + r.scrollLeft - r.clientLeft, y: t.clientY + r.scrollTop - r.clientTop },
                a = i(e);
                ...
                return (
                    ...
                    (t.prototype._getBorderSizes = function () {
                        ...
                        return (
                            this._currentBorders &&
                                (this._currentBorders[this._borders.left] && ((t.left = 1), t.horizontal++),
                                this._currentBorders[this._borders.right] && ((t.right = 1), t.horizontal++),
                                this._currentBorders[this._borders.top] && ((t.top = 1), t.vertical++),
                    ...
                    (t.prototype.setSize = function (t, e) {
                        ...
                        var i = this._getBorderSizes(),
                            n = e - i.vertical,
                            r = t - i.horizontal;
                        (this.$lastSize = { x: t, y: e, contentX: r, contentY: n }), this.$config.header ? this._sizeHeader() : this._sizeContent();
                    }),
                    (t.prototype._borders = { left: "gantt_layout_cell_border_left", right: "gantt_layout_cell_border_right", top: "gantt_layout_cell_border_top", bottom: "gantt_layout_cell_border_bottom" }),
    ...
    function (t, e) {
        ...
        var a = { second: 1, minute: 60, hour: 3600, day: 86400, week: 604800, month: 2592e3, quarter: 7776e3, year: 31536e3 };
    ...
    function (t, e, i) {
        ...
        (o.prototype = {
            ...
            setSize: function (t, e) {
                ...
                var s;
                (!isNaN(n) && this.$config.scrollable) || ((s = this._setColumnsWidth(t + 1)), (n = s)),
                    this.$config.scrollable ? ((this.$grid_scale.style.width = n + "px"), (this.$grid_data.style.width = n + "px")) : ((this.$grid_scale.style.width = "inherit"), (this.$grid_data.style.width = "inherit")),
                    (this.$config.width -= 1);
            ...
            getSize: function () {
                ...
                return { x: this.$state.width, y: this.$state.height, contentX: this.isVisible() ? n : 0, contentY: this.isVisible() ? t.scale_height + i : 0, scrollHeight: this.isVisible() ? i : 0, scrollWidth: this.isVisible() ? n : 0 };
            },
            refresh: function () {
            ...
            _initSmartRenderingPlaceholder: function () {
                ...
                e &&
                    ...
                    (this._staticBgHandler = e.attachEvent("onStoreUpdated", function (i, n, r) {
                ...
                for (var s = e + 1; s < n.length; s++) {
                    ...
                    l < 0
                        ? c.min_width && c.width + h < c.min_width
                            ...
                            : !c.min_width && i.min_grid_column_width && c.width + h < i.min_grid_column_width && (h = i.min_grid_column_width - c.width)
                        : c.max_width && c.width + h > c.max_width && (h = c.max_width - c.width),
                        (r -= c.width),
                        (c.width += h),
                        (l -= h);
                }
        ...
        function n(t, e) {
            ...
            return {
                attach: function (e, n, r, a) {
                    i.push({ element: e, event: n, callback: r, capture: a }), t(e, n, r, a);
                },
            ...
            s = (function (t) {
                ...
                return (
                    ...
                    (e.prototype._eachChild = function (t, e) {
                        if (((e = e || this), t(e), e.$cells)) for (var i = 0; i < e.$cells.length; i++) this._eachChild(t, e.$cells[i]);
                    }),
                        ...
                        for (var e, i, n, r = 0, a = 0, s = 0; s < this.$cells.length; s++)
                            (i = this.$cells[s]),
                                i.$config.hidden ||
                                    ...
                                    "scrollbar" === i.$config.view && t[i.$config.scroll] && ((e.height = 0), (e.width = 0)),
                                    i.$config.resizer && (this._xLayout ? (e.height = 0) : (e.width = 0)),
                                    (n = i._getBorderSizes()),
                                    this._xLayout ? ((r += e.width + n.horizontal), (a = Math.max(a, e.height + n.vertical))) : ((r = Math.max(r, e.width + n.horizontal)), (a += e.height + n.vertical)));
                        return (n = this._getBorderSizes()), (r += n.horizontal), (a += n.vertical), this.$root && ((r += 1), (a += 1)), { width: r, height: a };
                    }),
                    ...
                    (e.prototype._getBoxStyles = function (t) {
                        var e = null;
                        e = window.getComputedStyle ? window.getComputedStyle(t, null) : { width: t.clientWidth, height: t.clientHeight };
                    ...
                    (e.prototype.getSize = function () {
                        ...
                        for (var e = 0, i = 0, n = 1e5, r = 0, a = 1e5, s = 0, o = 0; o < this.$cells.length; o++) {
                            ...
                            this.$cells[o].$config.hidden ||
                                (this._xLayout
                                    ? (!l.width && l.minWidth ? (e += l.minWidth) : (e += l.width), (n += l.maxWidth), (i += l.minWidth), (r = Math.max(r, l.height)), (a = Math.min(a, l.maxHeight)), (s = Math.max(s, l.minHeight)))
                                    : (!l.height && l.minHeight ? (r += l.minHeight) : (r += l.height), (a += l.maxHeight), (s += l.minHeight), (e = Math.max(e, l.width)), (n = Math.min(n, l.maxWidth)), (i = Math.max(i, l.minWidth))));
                        }
                        ...
                        return (
                            ...
                            this._xLayout
                                ? ((d.minWidth += this.$config.margin * this.$cells.length || 0), (d.minWidth += 2 * this.$config.padding || 0), (d.minHeight += 2 * this.$config.padding || 0))
                                : ((d.minHeight += this.$config.margin * this.$cells.length || 0), (d.minHeight += 2 * this.$config.padding || 0)),
                            d
                        );
                    }),
                    (e.prototype._calcFreeSpace = function (t, e, i) {
                        ...
                        return (
                            a
                                ...
                                : ((a = Math.floor((this._free / this._gravity) * e.gravity)), a > r && ((a = r), (this._free -= a), (this._gravity -= e.gravity)), a < n && ((a = n), (this._free -= a), (this._gravity -= e.gravity))),
                            a
                        );
                    }),
    ...
    function (t, e, i) {
        ...
        (l.prototype = {
            ...
            scrollTo: function (t, e) {
                this.isVisible() &&
                    (1 * e === e && ((this.$config.scrollTop = e), (this.$task_data.scrollTop = this.$config.scrollTop)),
                    1 * t === t && ((this.$task.scrollLeft = t), (this.$config.scrollLeft = this.$task.scrollLeft), this._refreshScales()));
            },
            ...
            _createLayerConfig: function () {
                ...
                return {
                    tasks: [
                        { expose: !0, renderer: this.$gantt.$ui.layers.taskBar, container: this.$task_bars, filter: [e] },
                        {
            ...
            _attachLayers: function (t) {
                ...
                if (this.$config.bind) {
                    ...
                    for (var r = this.$config.layers, a = 0; r && a < r.length; a++) {
                        var s = r[a];
                        "string" == typeof s && (s = this.$gantt.$ui.layers[s]), "function" == typeof s && (s = { renderer: s }), (s.host = this);
                        var o = n.addLayer(s);
            ...
            _initStaticBackgroundRender: function () {
                var t = this,
                    ...
                    i = t.$config.rowStore;
                i &&
                    ((this._staticBgHandler = i.attachEvent("onStoreUpdated", function (i, n, r) {
                        if (null === i && t.isVisible()) {
                            var a = t.$getConfig();
            ...
            _prepareScaleHtml: function (t, e, i) {
                ...
                for (var u = c; u < h && t.trace_x[u]; u++) {
                    ...
                    var _ = l.call(this, o),
                        ...
                        k = "";
                    if (g) {
                        (v = "width:" + g + "px;height:" + f + "px;" + (r.smart_scales ? "position:absolute;left:" + p + "px" : "")),
            ...
            getItemPosition: function (t, e, i) {
                var n, r, a;
                return (
                    this._tasks.rtl ? ((r = this.posFromDate(e || t.start_date)), (n = this.posFromDate(i || t.end_date))) : ((n = this.posFromDate(e || t.start_date)), (r = this.posFromDate(i || t.end_date))),
                    (a = Math.max(r - n, 0)),
                    { left: n, top: this.getItemTop(t.id), height: this.getItemHeight(), width: a }
                );
            },
            getItemHeight: function () {
                var t = this.$getConfig(),
        ...
        (s.prototype = {
            ...
            addItem: function (t, e) {
                return (
                    ...
                    !(!this._skip_refresh && !1 === this.callEvent("onBeforeAdd", [t.id, t])) &&
                        (this._addItemInner(t, e), this._skip_refresh || (this.callEvent("onAfterAdd", [t.id, t]), this.callEvent("onStoreUpdated", [t.id, t, "add"])), t.id)
                );
            },
    ...
    function (t, e, i) {
        ...
        function o(t) {
            ...
            (l.start_date && l.end_date) ||
                ...
                (l.start_date = t.calculateEndDate({ start_date: t.date[i + "_start"](l.start_date), duration: -1, unit: i, step: o })),
                (l.end_date = t.date[i + "_start"](l.end_date)),
                (l.end_date = t.calculateEndDate({ start_date: l.end_date, duration: 2, unit: i, step: o }))),
            ...
            a = function (t) {
                return {
                    ...
                    isWorkTimeArguments: function () {
                        ...
                        return (
                            e.date
                                ? ((e = n.mixin({}, e)), (e.unit = e.unit || t.config.duration_unit), (e.task = e.task || null), (e.calendar = e.calendar || null))
                                : ((e = {}), (e.date = arguments[0]), (e.unit = arguments[1]), (e.task = arguments[2]), (e.calendar = arguments[3])),
                            (e.unit = e.unit || t.config.duration_unit),
                            e
                        );
                    },
                    getClosestWorkTimeArguments: function (e) {
                        return (e = arguments[0]), (e = r.isDate(e) ? { date: e } : n.mixin({}, e)), (e.dir = e.dir || "any"), (e.unit = e.unit || t.config.duration_unit), e;
                    },
                    ...
                    _getStartEndConfig: function (e) {
                        ...
                        return e instanceof n
                            ? e
                            : (r.isDate(e) ? (i = new n(arguments[0], arguments[1], arguments[2], arguments[3])) : ((i = new n(e.start_date, e.end_date, e.task)), e.id && (i.task = e)),
                    ...
                    calculateEndDateArguments: function (e, i, a, s) {
                        var o = arguments[0];
                        return (
                            (o = r.isDate(o) ? { start_date: arguments[0], duration: arguments[1], unit: arguments[2], task: arguments[3], calendar: arguments[4] } : n.mixin({}, o)),
    ...
    function (t, e, i) {
        function n() {
            (this.version = "5.1.2"), (this.templates = {}), (this.keys = { edit_save: 13, edit_cancel: 27 });
        }
        t.exports = function () {
            var t = new n();
        ...
        t.exports = function (t) {
            return {
                ...
                _call: function (e, i, r, a, s, o, l) {
                            ...
                            (d.onreadystatechange = function () {
                                if (4 == d.readyState || (c && 3 == d.readyState)) {
                                    ...
                                    window.setTimeout(function () {
                                        "function" == typeof s && s.apply(window, [{ xmlDoc: d, filePath: i }]), o && (void 0 !== o.postData ? this.postLong(o.url, o.postData, s) : this.getLong(o.url, s)), (s = null), (d = null);
                                    }, 1);
                                }
                            }),
                    ...
                    if ((d.setRequestHeader("X-Requested-With", "XMLHttpRequest"), d.send(r), !a)) return { xmlDoc: d, filePath: i };
                },
    ...
    function (t, e, i) {
        ...
        t.exports = function (t) {
            function e(t) {
                return { target: t.target || t.srcElement, pageX: t.pageX, pageY: t.pageY, clientX: t.clientX, clientY: t.clientY, metaKey: t.metaKey, shiftKey: t.shiftKey, ctrlKey: t.ctrlKey, altKey: t.altKey };
            }
            function i(i, a) {
            ...
            return (
                (i.prototype = {
                    ...
                    dragStart: function (e, i, n) {
                        (this.config = { obj: e, marker: null, started: !1, pos: this.getPosition(i), sensitivity: 4 }),
                    ...
                    getPosition: function (t) {
                        ...
                        return (
                            ...
                            t.pageX || t.pageY
                                ? ((e = t.pageX), (i = t.pageY))
                                : (t.clientX || t.clientY) && ((e = t.clientX + document.body.scrollLeft + document.documentElement.scrollLeft), (i = t.clientY + document.body.scrollTop + document.documentElement.scrollTop)),
                            { x: e, y: i }
                        );
                    },
                }),
        ...
        t.exports = function (t) {
            ...
            function o(e) {
                ...
                return (
                    ...
                    "bottom" == b.position && b.area.firstChild ? b.area.insertBefore(i, b.area.firstChild) : b.area.appendChild(i),
                    e.expire > 0 &&
            ...
            function d(i, r, a) {
                ...
                if (
                    ...
                    i.title && (c += '<div class="gantt_popup_title dhtmlx_popup_title">' + i.title + "</div>"),
                    (c += '<div class="gantt_popup_text dhtmlx_popup_text" id="' + d + '"><span>' + (i.content ? "" : i.text) + '</span></div><div  class="gantt_popup_controls dhtmlx_popup_controls">'),
                    r && (c += s(l(i.ok, t.locale.labels.message_ok, "OK"), "ok", !0)),
                    a && (c += s(l(i.cancel, t.locale.labels.message_cancel, "Cancel"), "cancel", !1)),
                    i.buttons)
                )
            ...
            function f(t, e, i, r) {
                return "object" != typeof t && (t = { text: t, type: e, expire: i, id: r }), (t.id = t.id || n.uid()), (t.expire = t.expire || b.expire), t;
            }
            var p = null;
    ...
    function (t, e, i) {
        var n = i(0),
            ...
            a = function (t) {
                ...
                var l = {},
                    d = {};
                return { initUI: e, reset: a, registerView: s, createView: i, getView: o };
            };
        ...
        var n = i(1),
            r = (function (t) {
                return function (e) {
                    ...
                    function n(t, e, i, n) {
                        var r = u[t][e];
                        if (r) for (var a = 0; a < r.length; a++) ((i || r[a].root) && r[a].root !== i) || r[a].handler.apply(this, n);
                    }
                    function r(t) {
                        t = t || window.event;
                    ...
                    function c(t, e, i, n) {
                        if (u[t]) for (var r = 0; r < u[t].length; r++) u[t][r].root == n && (u[t].splice(r, 1), r--);
                    }
                    function h(t) {
                            ...
                            addLayer: function (t) {
                                return (
                                    t &&
                                        ...
                                        void 0 === t.filter ? (t.filter = n(o || [])) : t.filter instanceof Array && (t.filter.push(o), (t.filter = n(t.filter))),
                                        t.container || (t.container = document.createElement("div"))),
                                    this._add(t),
                                    t ? t.id : void 0
                                );
                            },
            ...
            o = (function (t) {
                ...
                function e(e, i, n) {
                    ...
                    return (
                        ...
                        (s._callStartDNDEvent = function () {
                            if (
                                (this._xMode
                                    ? ((r = this._behind.$config.width || this._behind.$view.offsetWidth), (a = this._front.$config.width || this._front.$view.offsetWidth))
                                    : ((r = this._behind.$config.height || this._behind.$view.offsetHeight), (a = this._front.$config.height || this._front.$view.offsetHeight)),
                        ...
                        (s._downHandler = function (t) {
                            s._getSiblings(),
                                s._behind.$config.collapsed ||
                                    ...
                                    (s._positions = { x: t.pageX, y: t.pageY, timestamp: Date.now() }),
                ...
                return (
                    ...
                    (e.prototype._getSiblings = function () {
                        ...
                        this.$config.prev && ((this._behind = this.$factory.getView(this.$config.prev)), this._behind instanceof s || (this._behind = this._behind.$parent)),
                            this.$config.next && ((this._front = this.$factory.getView(this.$config.next)), this._front instanceof s || (this._front = this._behind.$parent));
                    ...
                    (e.prototype._getResizePosition = function (t, e) {
                        ...
                        return -1 === d ? ((l = a - i), (o = n - Math.abs(i))) : ((l = a - Math.abs(i)), (o = n + i)), { size: i, newFrontSide: l, newBehindSide: o };
                    }),
                    ...
                    (e.prototype._moveResizer = function (t, e, i) {
                        if (0 !== e) {
                            ...
                            n &&
                                1 !== Math.abs(n.size) &&
                                (this._xMode ? ((t.style.left = n.size + "px"), (this._positions.nextX = n.size || 0)) : ((t.style.top = n.size + "px"), (this._positions.nextY = n.size || 0)),
                    ...
                    (e.prototype._setSizes = function () {
                        ...
                        if (this._positions.nextX || this._positions.nextY) {
                            ...
                            this._front.$config.group
                                ? this.$gantt.$layout._syncCellSizes(this._front.$config.group, this._front.$config[e])
                                : this._behind.$config.group && this.$gantt.$layout._syncCellSizes(this._behind.$config.group, this._behind.$config[e]),
    ...
    function (t, e, i) {
        var n = i(3),
            ...
            l = (function (t) {
                ...
                function i(t, e) {
                    if ((e.push(t), t.$cells)) for (var n = 0; n < t.$cells.length; n++) i(t.$cells[n], e);
                }
                return (
                    n(e, t),
                    ...
                    (e.prototype._initLinkedViews = function () {
                        for (
                            var t = this._getLinkedViews(), e = this._isVertical() ? "gantt_layout_outer_scroll gantt_layout_outer_scroll_vertical" : "gantt_layout_outer_scroll gantt_layout_outer_scroll_horizontal", i = 0;
                            i < t.length;
                            i++
                        )
                    ...
                    (e.prototype._getScrollSize = function () {
                        for (
                            var t, e = 0, i = 0, n = this._isHorizontal(), r = this._getLinkedViews(), a = n ? "scrollWidth" : "scrollHeight", s = n ? "contentX" : "contentY", o = n ? "x" : "y", l = this._getScrollOffset(), d = 0;
                            d < r.length;
                            d++
                        )
                    ...
                    (e.prototype._setScrollSize = function (t) {
                        ...
                        n
                            ? this._isVertical()
                                ...
                                : ((this.$config.outerSize = this.$config.width - n + 1), (i.style.width = this.$config.outerSize + "px"))
                            : ((i.style.top = "auto"), r.removeClassName(i, this.$parent._borders.top), r.removeClassName(i.parentNode, "gantt_task_vscroll"), (this.$config.outerSize = this.$config.height)),
                            (a.style[e] = t + "px");
                    }),
        ...
        function n(t) {
            ...
            return {
                ...
                primaryScale: function () {
                    return (
                        i.getService("templateLoader").initTemplate("date_scale", void 0, void 0, i.config(), i.templates()),
                        { unit: i.config().scale_unit, step: i.config().step, template: i.templates().date_scale, date: i.config().date_scale, css: i.templates().scale_cell_class }
                    );
                },
                ...
                initScaleConfig: function (t, e, i) {
                    var n = r.mixin({ count: 0, col_width: 0, full_width: 0, height: 0, width: [], left: [], trace_x: [], trace_indexes: {}, min_date: new Date(e), max_date: new Date(i) }, t);
                    return (
                ...
                function d(t, e, i) {
                    ...
                    return (
                        (function (t, e, i, a, s, o) {
                            ...
                            for (var d = 1 * o.rightBorderWidth, c = r(o.rightBorderColor), h = 0, u = 0, _ = 0, g = 1; g <= a; g++) for (h = g * e - 1, _ = 0; _ < d; _++) for (u = 0; u < t * i; u++) n(h - _, u, c, l);
                            var f = 1 * o.bottomBorderWidth,
                                p = r(o.bottomBorderColor);
                            u = 0;
                            for (var v = 1; v <= i; v++) for (u = v * t - 1, _ = 0; _ < f; _++) for (h = 0; h < e * a; h++) n(h, u - _, p, l);
                    ...
                    n.mixin(
                        e.prototype,
                        {
                            ...
                            _createLayerConfig: function () {
                                ...
                                return {
                                    tasks: [
                                        { renderer: this.$gantt.$ui.layers.resourceRow, container: this.$task_bars, filter: [e] },
    ...
    function (t, e) {
        function i(t) {
            ...
            function d(e) {
                return e
                    ? { $source: [t.config.links.start_to_start], $target: [t.config.links.start_to_start, t.config.links.finish_to_start] }
                    : { $source: [t.config.links.finish_to_start, t.config.links.finish_to_finish], $target: [t.config.links.finish_to_finish] };
            }
            function c(e, i, n, r) {
                var a = r.$getConfig(),
                    s = [e];
                ...
                var o = t.getState(),
                    l = t.getTask(n);
                if (
                    (t.getTaskType(l.type) == a.types.milestone && s.push("gantt_milestone"),
                    ...
                    n == o.drag_id && (s.push("gantt_drag_" + o.drag_mode), o.touch_drag && s.push("gantt_touch_" + o.drag_mode)),
                    o.link_source_id == n && s.push("gantt_link_source"),
                    o.link_target_id == n && s.push("gantt_link_target"),
                    a.highlight_critical_path && t.isCriticalTask && t.isCriticalTask(l) && s.push("gantt_critical_task"),
            ...
            function h(e, i, n, r, a) {
                var s,
                    o,
                    l = t.getState();
                +n.start_date >= +l.min_date && ((s = [i, a.rtl ? "task_right" : "task_left", "task_start_date"]), (o = r(s.join(" "))), o.setAttribute("data-bind-property", "start_date"), e.appendChild(o)),
                    +n.end_date <= +l.max_date && ((s = [i, a.rtl ? "task_left" : "task_right", "task_end_date"]), (o = r(s.join(" "))), o.setAttribute("data-bind-property", "end_date"), e.appendChild(o));
            }
            return e;
        }
        t.exports = i;
    ...
    function (t, e) {
        function i(t) {
            function e(e, i) {
                ...
                return (
                    i.$config.rowStore.getSelectedId() == e.id && (g += " gantt_selected"),
                    (o.className = g),
        ...
        function i(t) {
            ...
            var r = {
                    ...
                    render_line: function (t, e, i) {
                        ...
                        return (
                            (s.style.cssText = ["height:" + a.height + "px", "width:" + a.width + "px", "margin-top:" + a.marginTop + "px", "margin-left:" + a.marginLeft + "px"].join(";")),
                ...
                a = {
                    ...
                    get_endpoint: function (e, i) {
                        var r = i.$getConfig(),
                            ...
                            c = n(l, i),
                            h = n(d, i);
                        return { x: s ? c.left : c.left + c.width, e_x: o ? h.left : h.left + h.width, y: c.top, e_y: h.top };
                    },
                };
            return e;
        }
        ...
        function n(t) {
            function e(e, i) {
                ...
                return (
                    ...
                    a.smart_rendering && (($.style.position = "absolute"), ($.style.left = "0px"), ($.style.top = i.getItemTop(e.id) + "px")),
                    i.$config.item_attribute && $.setAttribute(i.$config.item_attribute, e.id),
                ...
                return function (t) {
                    return {
                        onCreated: function (e) {
                            (e.$config = n.mixin(e.$config, { bind: "task" })), "grid" == e.$config.id && this.extendGantt(e), (this._mouseDelegates = i(9)(t));
                        },
                                    ...
                                    e.bind(function (i, n, r) {
                                        ...
                                        if (e.callEvent("onGridHeaderClick", [a, i])) {
                                            ...
                                            if (s.sort) {
                                                ...
                                                (c = "desc" == c ? "asc" : "desc"), (this._sort = { name: a, direction: c }), this.sort(l, "desc" == c);
                                            }
                                        }
                                    }, e),
                                    t.$grid
    ...
    function (t, e, i) {
        function n(t, e) {
            ...
            if (e.$config.bind && t.getDatastore(e.$config.bind)) {
                ...
                t.defined(e.$getConfig().dnd_sensitivity) && (s.config.sensitivity = e.$getConfig().dnd_sensitivity),
                    s.attachEvent(
                        "onBeforeDragStart",
                        t.bind(function (r, a) {
                            var o = i(a);
                    ...
                    s.attachEvent(
                        ...
                        t.bind(function (t, i) {
                            ...
                            if ((d.exists(u) || ((u = s.lastTaskOfLevel(l.order_branch_free ? c.$level : 0)) == s.config.id && (u = null)), d.exists(u))) {
                                ...
                                for (var g = d.getIndexById(_.id), v = d.getIdByIndex(g - 1), m = d.getItem(v), k = 1; (!m || m.id == _.id) && g - k >= 0; ) (v = d.getIdByIndex(g - k)), (m = d.getItem(v)), k++;
                                if (c.id == _.id) return;
                    ...
                    s.attachEvent(
                        ...
                        t.bind(function () {
                            ...
                            (e.$transparent = !1),
                                ...
                                !1 === this.callEvent("onBeforeRowDragEnd", [s.config.id, s.config.parent, s.config.index])
                                    ? (t.move(s.config.id, s.config.index, s.config.parent), (e.$drop_target = null))
                                    : this.callEvent("onRowDragEnd", [s.config.id, e.$drop_target]),
                                t.refresh(e.id);
                        }, t)
                    );
            }
        ...
        function n(t, e) {
            ...
            return {
                ...
                init: function () {
                    ...
                    var n = { before_start: "onBeforeTaskDrag", before_finish: "onBeforeTaskChanged", after_finish: "onAfterTaskDrag" };
                    for (var r in this._events) for (var a in t) this._events[r][a] = n[r];
                ...
                _resize: function (i, n, r) {
                    ...
                    r.left
                        ? ((i.start_date = e.dateFromPos(s.start + n)), i.start_date || (i.start_date = new Date(e.getState().min_date)))
                        : ((i.end_date = e.dateFromPos(s.end + n)), i.end_date || (i.end_date = new Date(e.getState().max_date))),
                        i.end_date - i.start_date < a.min_duration &&
                            (r.left ? (i.start_date = e.calculateEndDate({ start_date: i.end_date, duration: -1, task: i })) : (i.end_date = e.calculateEndDate({ start_date: i.start_date, duration: 1, task: i }))),
                ...
                _move: function (t, i, n) {
                    ...
                    a
                        ? s
                            ...
                            : ((t.end_date = new Date(e.getState().max_date)), (t.start_date = e.dateFromPos(e.posFromDate(t.end_date) - (r.end - r.start))))
                        : ((t.start_date = new Date(e.getState().min_date)), (t.end_date = e.dateFromPos(e.posFromDate(t.start_date) + (r.end - r.start))));
                },
                _drag_task_coords: function (t, i) {
                    return { start: (i.obj_s_x = i.obj_s_x || e.posFromDate(t.start_date)), end: (i.obj_e_x = i.obj_e_x || e.posFromDate(t.end_date)) };
                },
                ...
                on_mouse_move: function (t) {
                    if (this.drag.start_drag) {
                        ...
                        (Date.now() - this.drag.timestamp > 50 || (this._is_number(n) && this._is_number(r) && this._mouse_position_change({ x: n, y: r }, i) > 20)) && this._start_dnd(t);
                    }
                    if (this.drag.mode) {
                        if (!o(this, 40)) return;
                ...
                _fix_dnd_scale_time: function (i, n) {
                    function r(i) {
                        if (e.config.correct_work_time) {
                            var n = t.$getConfig();
                            e.isWorkTime(i.start_date, void 0, i) || (i.start_date = e.calculateEndDate({ start_date: i.start_date, duration: -1, unit: n.duration_unit, task: i }));
                        }
                    }
                    var a = t.$getConfig(),
                        s = e.getScale().unit,
                    ...
                    a.round_dnd_dates || ((s = "minute"), (o = a.time_step)),
                        n.mode == a.drag_mode.resize
                            ? n.left
                                ? ((i.start_date = e.roundDate({ date: i.start_date, unit: s, step: o })), r(i))
                                : ((i.end_date = e.roundDate({ date: i.end_date, unit: s, step: o })),
                                  (function (i) {
                                      if (e.config.correct_work_time) {
                                          var n = t.$getConfig();
                                          e.isWorkTime(new Date(i.end_date - 1), void 0, i) || (i.end_date = e.calculateEndDate({ start_date: i.end_date, duration: 1, unit: n.duration_unit, task: i }));
                                      }
                                  })(i))
                            : n.mode == a.drag_mode.move && ((i.start_date = e.roundDate({ date: i.start_date, unit: s, step: o })), r(i), (i.end_date = e.calculateEndDate(i)));
                },
                _fix_working_times: function (i, n) {
                    ...
                    n.mode == r.drag_mode.resize
                        ? n.left
                            ? (i.start_date = e.getClosestWorkTime({ date: i.start_date, dir: "future", task: i }))
                            : (i.end_date = e.getClosestWorkTime({ date: i.end_date, dir: "past", task: i }))
    ...
    function (t, e, i) {
        var n = i(1),
            r = function (t, e) {
                ...
                function a() {
                    return { link_source_id: k, link_target_id: v, link_from_start: y, link_to_start: m, link_landing_area: p };
                }
        ...
        function i() {
            ...
            return {
                ...
                getTaskPosition: function (e, i, n) {
                    ...
                    if (s === a) {
                        return { left: 0, top: this.getTaskTop(e.id), height: this.getTaskHeight(), width: 0 };
                    }
                    return s;
                },
        ...
        function n(t) {
            ...
            function d(e) {
                ...
                return (
                    ...
                    i && (e.start_date && !e.end_date ? (e.end_date = this.calculateEndDate(e)) : !e.start_date && e.end_date && (e.start_date = this.calculateEndDate({ start_date: e.end_date, duration: -e.duration, task: e }))),
            ...
            u.attachEvent("onBeforeRefreshAll", function () {
                ...
                _.attachEvent("onBeforeIdChange", function (i, r) {
                    n(t.mixin({ id: i }, t.$data.linksStore.getItem(r))), e(t.$data.linksStore.getItem(r));
                }),
                _.attachEvent("onFilterItem", function (e, i) {
                    return (
                        !!t.config.show_links &&
                        !(!t.isTaskVisible(i.source) || !t.isTaskVisible(i.target) || t._isAllowedUnscheduledTask(t.getTask(i.source)) || t._isAllowedUnscheduledTask(t.getTask(i.target))) &&
            ...
            var r = e.getDatastore(t),
                a = {
                    renderItem: function (t, e) {
                        var i = e.getLayers(),
                            n = r.getItem(t);
                        if (n && r.isVisible(t)) for (var a = 0; a < i.length; a++) i[a].render_item(n);
                    },
            ...
            r.attachEvent("onStoreUpdated", function (n, s, o) {
                if (!i(e)) {
                    ...
                    l &&
                        (r.filter(),
                        n && "move" != o && "delete" != o
                            ? (r.callEvent("onBeforeRefreshItem", [s.id]), a.renderItem(s.id, l), r.callEvent("onAfterRefreshItem", [s.id]))
                            : (r.callEvent("onBeforeRefreshAll", []), a.renderItems(l), r.callEvent("onAfterRefreshAll", [])));
                }
            }),
        ...
        function n(t) {
            ...
            function n(t, e) {
                (e.setGanttMode = function (t) {
                    var i = e.modes || {};
                    e._ganttMode && (i[e._ganttMode] = { _in_progress: e._in_progress, _invalid: e._invalid, updatedRows: e.updatedRows });
                    var n = i[t];
                    n || (n = i[t] = { _in_progress: {}, _invalid: {}, updatedRows: [] }), (e._in_progress = n._in_progress), (e._invalid = n._invalid), (e.updatedRows = n.updatedRows), (e.modes = i), (e._ganttMode = t);
                }),
                    (d = e.afterUpdate),
                    ...
                    (e._getRowData = t.bind(function (i, n) {
                        var r;
                        (r = "tasks" == e._ganttMode ? (this.isTaskExists(i) ? this.getTask(i) : { id: i }) : this.isLinkExists(i) ? this.getLink(i) : { id: i }), (r = t.copy(r));
                        var s = {};
                        for (var o in r)
                            if ("$" != o.substr(0, 1)) {
                                var l = r[o];
            ...
            function l(t, e) {
                ...
                c.push(
                    this.attachEvent("onBeforeTaskDelete", function (e, i) {
                        return !t.config.cascade_delete || ((s[e] = { tasks: a.getSubtreeTasks(t, e), links: a.getSubtreeLinks(t, e) }), !0);
                    })
                ),
                    c.push(
            ...
            (t._dp_init = function (i) {
                t.assert(!this._dp, "The dataProcessor is already attached to this gantt instance"),
                    ...
                    (i.serverProcessor += (-1 != i.serverProcessor.indexOf("?") ? "&" : "?") + "editing=true"),
                    (i._serverProcessor = i.serverProcessor),
                    (i.$gantt = this),
                    (i.styles = { updated: "gantt_updated", order: "gantt_updated", inserted: "gantt_inserted", deleted: "gantt_deleted", invalid: "gantt_invalid", error: "gantt_error", clear: "" }),
                    (i._methods = ["_row_style", "setCellTextStyle", "_change_id", "_delete_task"]),
                    n.call(this, t, i),
                    o.call(this, t, i),
                    l.call(this, t, i),
        ...
        (a.prototype = {
            ...
            setUpdated: function (t, e, i) {
                if (!this._silent_mode) {
                    ...
                    r && "updated" == i && (i = r),
                        e
                            ? (this.set_invalid(t, !1), (this.updatedRows[n] = t), this.obj.setUserData(t, this.action_param, i), this._in_progress[t] && (this._in_progress[t] = "wait"))
                            : this.is_invalid(t) || (this.updatedRows.splice(n, 1), this.obj.setUserData(t, this.action_param, "")),
            ...
            _sendData: function (t, e) {
                if (t) {
                    ...
                    if ("GET" == this._tMode) r.query({ url: s + r.urlSeparator(s) + this.serialize(t, e), method: "GET", callback: n, headers: this._headers });
                    else if ("POST" == this._tMode) r.query({ url: s, method: "POST", headers: this._headers, data: this.serialize(t, e), callback: n });
                    else if ("JSON" == this._tMode) {
                        var o = t[this.action_param],
                            l = {};
                        for (var d in t) l[d] = t[d];
                        delete l[this.action_param], delete l.id, delete l.gr_id, r.query({ url: s, method: "POST", headers: this._headers, callback: n, data: JSON.stringify({ id: e, action: o, data: l }) });
                        ...
                        "inserted" == c
                            ...
                            : "deleted" == c
                            ? ((u = "DELETE"), (h = h + ("/" == h.slice(-1) ? "" : "/") + e))
                            : ((u = "PUT"), (l = this.serialize(t, e)), (h = h + ("/" == h.slice(-1) ? "" : "/") + e)),
                            (h = this._applyPayload(h)),
                            r.query({ url: h, method: u, headers: this._headers, data: l, callback: n });
                    }
                    this._waitMode++;
                }
            },
            ...
            function a(i, n, r) {
                for (var a = e(i, n), s = r.unit, o = {}, l = 0; l < a.length; l++)
                    for (var d = a[l], c = t.date[s + "_start"](new Date(d.start_date)); c < d.end_date; ) {
                        var h = c;
                        if (((c = t.date.add(c, 1, s)), t.isWorkTime({ date: h, task: d }))) {
                            var u = h.valueOf();
                ...
                var _,
                    g,
                    f = [];
                for (var l in o) (_ = new Date(1 * l)), (g = t.date.add(_, 1, s)), f.push({ start_date: _, end_date: g, tasks: o[l].tasks });
                return f;
            }
            function s(t, e) {
        ...
        t.exports = function (t) {
            ...
            t._waiAria = {
                ...
                gridScaleCellAttrString: function (e, i) {
                    var n = "";
                    if ("add" == e.name) n = this.getAttributeString({ role: "button", "aria-label": t.locale.labels.new_task });
                    else {
                    ...
                    _getCollections: function (e) {
                        for (var i = {}, n = t.ajax.xpath("//coll_options", e), r = 0; r < n.length; r++)
                            for (var a = n[r].getAttribute("for"), s = (i[a] = []), o = t.ajax.xpath(".//item", n[r]), l = 0; l < o.length; l++) {
                                for (var d = o[l], c = d.attributes, h = { key: o[l].getAttribute("value"), label: o[l].getAttribute("label") }, u = 0; u < c.length; u++) {
                                    var _ = c[u];
                    ...
                    parse: function (e, i) {
                        ...
                        for (var s = 0; s < r.length; s++) {
                            ...
                            (l.start_date = l.startdate || l.est),
                                ...
                                l.predecessortasks && n.collections.links.push({ target: l.id, source: l.predecessortasks, type: t.config.links.finish_to_start });
                        }
                        return n;
                    },
                    serialize: function () {
            ...
            _getDayHoursForMultiple: function (t, e) {
                for (var i = [], n = !0, r = 0, a = !1, s = this.$gantt.date.day_start(new Date(e)), o = 0; o < 24; o++)
                    (a = t.reduce(function (t, e) {
                        ...
                        a ? (n ? ((i[r] = o), (i[r + 1] = o + 1), (r += 2)) : (i[r - 1] += 1), (n = !1)) : n || (n = !0),
                ...
                for (var _ = !1; a.valueOf() < s.valueOf(); )
                    (c = this._nextDate(a, i, n)),
                        ...
                        this._isWorkTime(a, i) &&
                            ((h || (u && _)) && ((o = r[i + "_start"](new Date(a))), (l = r.add(o, n, i))),
                            h ? ((h = !1), (c = this._nextDate(o, i, n)), (d += (l.valueOf() - a.valueOf()) / (l.valueOf() - o.valueOf()))) : u && _ ? ((u = !1), (d += (s.valueOf() - a.valueOf()) / (l.valueOf() - o.valueOf()))) : d++),
                        (a = c);
                return d;
            },
            ...
            (t.isUnscheduledTask = function (t) {
                ...
                (t._defaultTaskDate = function (e, i) {
                    ...
                    if (n) r = n.start_date;
                        ...
                        r = a ? (a.start_date ? a.start_date : a.end_date ? this.calculateEndDate({ start_date: a.end_date, duration: -this.config.duration_step }) : "") : this.config.start_date || this.getState().min_date;
                    }
                ...
                (t.createTask = function (e, i, n) {
                    if (
                        ((e = e || {}), t.defined(e.id) || (e.id = t.uid()), e.start_date || (e.start_date = t._defaultTaskDate(e, i)), void 0 === e.text && (e.text = t.locale.labels.new_task), void 0 === e.duration && (e.duration = 1), i)
                    ) {
                    ...
                    return this.callEvent("onTaskCreated", [e])
                        ? (this.config.details_on_create
                              ...
                              : this.addTask(e, i, n) && (this.showTask(e.id), this.selectTask(e.id)),
                          e.id)
                        : null;
                }),
                (t._update_flags = function (e, i) {
                    ...
                    void 0 === e
                        ? ((this._lightbox_id = null),
                          ...
                          this._tasks_dnd && this._tasks_dnd.drag && (this._tasks_dnd.drag.id = null))
                ...
                (t._get_task_timing_mode = function (t, e) {
                    ...
                    return e || i != t.$rendered_type
                        ? (i == this.config.types.project
                              ...
                              : i != this.config.types.milestone && ((n.$no_end = !(t.end_date || t.duration)), (n.$no_start = !t.start_date), this._isAllowedUnscheduledTask(t) && (n.$no_end = n.$no_start = !1)),
                          n)
                    ...
                    return (
                        this.eachTask(function (e) {
                            this.getTaskType(e.type) == t.config.types.project ||
                                ...
                                (e.start_date && !e.$no_start && (!i || i > e.start_date.valueOf()) && (i = e.start_date.valueOf()), e.end_date && !e.$no_end && (!n || n < e.end_date.valueOf()) && (n = e.end_date.valueOf()));
                        }, r),
                        { start_date: i ? new Date(i) : null, end_date: n ? new Date(n) : null }
                    );
                }),
                (t._assign_project_dates = function (t, e, i) {
                    ...
                    n.$no_start && (t.start_date = e && e != 1 / 0 ? new Date(e) : this._defaultTaskDate(t, this.getParent(t))),
                        n.$no_end && (t.end_date = i && i != -1 / 0 ? new Date(i) : this.calculateEndDate({ start_date: t.start_date, duration: this.config.duration_step, task: t })),
                ...
                (t.roundDate = function (e) {
                    var i = t.getScale();
                    n.isDate(e) && (e = { date: e, unit: i ? i.unit : t.config.duration_unit, step: i ? i.step : t.config.duration_step });
                    var r = e.date,
                        a = e.step,
                        s = e.unit;
                    if (!i) return r;
                ...
                (t.correctTaskWorkTime = function (e) {
                    t.config.work_time &&
                        ...
                        (this.isWorkTime(e.start_date, void 0, e)
                            ? this.isWorkTime(new Date(+e.end_date - 1), void 0, e) || (e.end_date = this.calculateEndDate(e))
                            : ((e.start_date = this.getClosestWorkTime({ date: e.start_date, dir: "future", task: e })), (e.end_date = this.calculateEndDate(e))));
                }),
            ...
            (t._lightbox_methods = {}),
                    ...
                    if ((void 0 === e && (e = this.getLightboxType()), !this._lightbox || this.getLightboxType() != this.getTaskType(e))) {
                        ...
                        for (var r, a = this._lightbox_template, s = this.config.buttons_left, o = 0; o < s.length; o++) {
                            ...
                            (r = this._waiAria.lightboxButtonAttrString(l)),
                                (a += "<div " + r + " class='gantt_btn_set gantt_left_btn_set " + l + "_set'><div dhx_button='1' class='" + l + "'></div><div>" + this.locale.labels[l] + "</div></div>");
                        }
                        s = this.config.buttons_right;
                        for (var o = 0; o < s.length; o++) {
                            var l = this.config._migrate_buttons[s[o]] ? this.config._migrate_buttons[s[o]] : s[o];
                            (r = this._waiAria.lightboxButtonAttrString(l)),
                                (a += "<div " + r + " class='gantt_btn_set gantt_right_btn_set " + l + "_set' style='float:right;'><div dhx_button='1' class='" + l + "'></div><div>" + this.locale.labels[l] + "</div></div>");
                        }
                        (a += "</div>"),
                            (i.innerHTML = a),
                    ...
                    (t.lightbox_events = {}),
                        ...
                        (t.lightbox_events.default = function (e, i) {
                            if (i.getAttribute("dhx_button")) t.callEvent("onLightboxButton", [i.className, i, e]);
                                ...
                                if (-1 != o.indexOf("gantt_custom_button"))
                                    if (-1 != o.indexOf("gantt_custom_button_")) for (n = i.parentNode.getAttribute("index"), s = i; s && -1 == r.getClassName(s).indexOf("gantt_cal_lsection"); ) s = s.parentNode;
                        ...
                        this.event(t.getLightbox(), "click", function (e) {
                            ...
                            return (
                                ...
                                i && n && 0 === n.indexOf("gantt_btn_set") && ((i = i.firstChild), (n = r.getClassName(i))),
                                !(!i || !n) && (t.defined(t.lightbox_events[i.className]) ? t.lightbox_events[i.className] : t.lightbox_events.default)(e, i)
                            );
                        }),
                ...
                (t._save_lightbox = function () {
                    ...
                    this.callEvent("onLightboxSave", [this._lightbox_id, t, !!t.$new]) &&
                        (t.$new ? (delete t.$new, this.addTask(t)) : this.isTaskExists(t.id) && (this.mixin(this.getTask(t.id), t, !0), this.refreshTask(t.id), this.updateTask(t.id)), this.refreshData(), this.hideLightbox());
                }),
                (t._resolve_default_mapping = function (t) {
                    var e = t.map_to;
                    return (
                        { time: !0, time_optional: !0, duration: !0, duration_optional: !0 }[t.type] &&
                            ("auto" == t.map_to ? (e = { start_date: "start_date", end_date: "end_date", duration: "duration" }) : "string" == typeof t.map_to && (e = { start_date: t.map_to })),
                        e
                    );
                }),
                ...
                (t._set_lightbox_values = function (e, i) {
                    ...
                    t.templates.lightbox_header
                        ? (a.push(""), a.push(t.templates.lightbox_header(n.start_date, n.end_date, n)), (r[1].innerHTML = ""), (r[2].innerHTML = t.templates.lightbox_header(n.start_date, n.end_date, n)))
                        : (a.push(this.templates.task_time(n.start_date, n.end_date, n)),
                          a.push((this.templates.task_text(n.start_date, n.end_date, n) || "").substr(0, 70)),
                          (r[1].innerHTML = this.templates.task_time(n.start_date, n.end_date, n)),
                          (r[2].innerHTML = (this.templates.task_text(n.start_date, n.end_date, n) || "").substr(0, 70))),
                        (r[1].innerHTML = a[0]),
                        (r[2].innerHTML = a[1]),
                ...
                (t.form_blocks = {
                        ...
                        for (var h = "", u = 0; u < n.length; u++) {
                            ...
                            switch (_) {
                                case "%Y":
                                    ...
                                    var f, p, v, m;
                                    e.year_range && (isNaN(e.year_range) ? e.year_range.push && ((v = e.year_range[0]), (m = e.year_range[1])) : (f = e.year_range)),
                                        (f = f || 10),
                                        (p = p || Math.floor(f / 2)),
                                        (v = v || l.getFullYear() - p),
                                        (m = m || v + f);
                                ...
                                case "%H:%i":
                                    ...
                                    for (e._time_values = []; k < d; )
                                        (g += "<option value='" + k + "'>" + this.templates.time_picker(l) + "</option>"),
                                            e._time_values.push(k),
                                            l.setTime(l.valueOf() + 60 * this._get_timepicker_step() * 1e3),
                                            (k = 24 * (l.getDate() != y ? 1 : 0) * 60 + 60 * l.getHours() + l.getMinutes());
                            }
                            if (g) {
                    ...
                    time: {
                        ...
                        set_value: function (e, i, n, r) {
                            ...
                            if ((r._time_format_size, a.auto_end_date))
                                for (
                                    var l = function () {
                                            (h = new Date(s[o[2]].value, s[o[1]].value, s[o[0]].value, 0, 0)), (u = t.calculateEndDate({ start_date: h, duration: 1, task: n })), this.form_blocks._fill_lightbox_select(s, o.size, u, o, a);
                                        },
                                        d = 0;
                                    d < 4;
                                    d++
                            ...
                            var h = n[c.start_date] || new Date(),
                                u = n[c.end_date] || t.calculateEndDate({ start_date: h, duration: 1, task: n });
                    ...
                    duration: {
                        ...
                        set_value: function (e, i, n, r) {
                            function a() {
                                var i = t.form_blocks.duration._get_start_date.call(t, e, r),
                                    ...
                                    s = t.calculateEndDate({ start_date: i, duration: a, task: n });
                            ...
                            var f = n[g.start_date] || new Date(),
                                p = n[g.end_date] || t.calculateEndDate({ start_date: f, duration: 1, task: n }),
                                v = Math.round(n[g.duration]) || t.calculateDuration({ start_date: f, end_date: p, task: n });
                        ...
                        get_value: function (e, i, n) {
                            var r = t.form_blocks.duration._get_start_date(e, n),
                                ...
                                l = { start_date: new Date(r), end_date: new Date(s), duration: a };
                    ...
                    parent: {
                        ...
                        _display: function (e, i) {
                            var n = [],
                                r = [];
                            i && ((n = t.getTaskByTime()), e.allow_root && n.unshift({ id: t.config.root_id, text: e.root_label || "" }), (n = this._filter(n, e, i)), e.sort && n.sort(e.sort));
    ...
    function (t, e) {
        t.exports = function (t) {
            (t.getTaskType = function (e) {
                ...
                for (var n in this.config.types) if (this.config.types[n] == i) return i;
                ...
                (t.form_blocks.typeselect = {
                    render: function (e) {
                        ...
                        for (var s in i) !1 == !a(s, i[s]) && r.push({ key: i[s], label: n["type_" + s] });
                        e.options = r;
                        var o = e.onchange;
                        return (
                            (e.onchange = function () {
        ...
        t.exports = function (t) {
            ...
            (t._cached_functions = {
                ...
                update_if_changed: function (t) {
                    (this.critical_path_mode != t.config.highlight_critical_path || this.mode !== t.config.optimize_render) &&
                        ((this.critical_path_mode = t.config.highlight_critical_path), (this.mode = t.config.optimize_render), this.setup(t));
                },
            }),
    ...
    function (t, e) {
        ...
        function n(t, e) {
            ...
            for (var a = 0; a < l.length; a++) {
                ...
                "add" == d.name &&
                    (d.width || (d.width = 44),
                    (e.defined(d.min_width) && e.defined(d.max_width)) || ((d.min_width = d.min_width || d.width), (d.max_width = d.max_width || d.width)),
                    d.min_width && (d.min_width = +d.min_width),
                    d.max_width && (d.max_width = +d.max_width),
                    d.width && ((d.width = +d.width), (d.width = d.min_width && d.min_width > d.width ? d.min_width : d.width), (d.width = d.max_width && d.max_width < d.width ? d.max_width : d.width)));
            }
    ...
    function (t, e) {
        t.exports = function (t) {
            t.skins.skyblue = { config: { grid_width: 350, row_height: 27, scale_height: 27, link_line_width: 1, link_arrow_size: 8, lightbox_additional_height: 75 }, _second_column_width: 95, _third_column_width: 80 };
        };
    },
    function (t, e) {
        t.exports = function (t) {
            t.skins.meadow = { config: { grid_width: 350, row_height: 27, scale_height: 30, link_line_width: 2, link_arrow_size: 6, lightbox_additional_height: 72 }, _second_column_width: 95, _third_column_width: 80 };
        };
    },
    function (t, e) {
        t.exports = function (t) {
            t.skins.terrace = { config: { grid_width: 360, row_height: 35, scale_height: 35, link_line_width: 2, link_arrow_size: 6, lightbox_additional_height: 75 }, _second_column_width: 90, _third_column_width: 70 };
        };
    },
    function (t, e) {
        t.exports = function (t) {
    ...
    function (t, e) {
        t.exports = function (t) {
            (t.skins.material = {
                config: { grid_width: 411, row_height: 34, task_height_offset: 6, scale_height: 36, link_line_width: 2, link_arrow_size: 6, lightbox_additional_height: 80 },
    ...
    function (t, e) {
        t.exports = function (t) {
            t.skins.contrast_black = { config: { grid_width: 360, row_height: 35, scale_height: 35, link_line_width: 2, link_arrow_size: 6, lightbox_additional_height: 75 }, _second_column_width: 100, _third_column_width: 80 };
        };
    },
    function (t, e) {
        t.exports = function (t) {
            t.skins.contrast_white = { config: { grid_width: 360, row_height: 35, scale_height: 35, link_line_width: 2, link_arrow_size: 6, lightbox_additional_height: 75 }, _second_column_width: 100, _third_column_width: 80 };
        };
    },
    function (t, e) {
        t.exports = function (t) {
                            ...
                            if (!a(i)) {
                                ...
                                _ = setTimeout(function () {
                                    ...
                                    n &&
                                        ...
                                        (n.on_mouse_down(u), n.drag && n.drag.start_drag && (o(e), n._start_dnd(u), (t._touch_drag = !0), t.refreshTask(e), t._touch_feedback())),
                                        (_ = null);
                                }, t.config.touch_drag);
                            }
                        },
