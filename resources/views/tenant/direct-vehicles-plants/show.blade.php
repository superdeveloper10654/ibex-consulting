...
@section('title') Direct Vehicles & Plants #{{ $directVehiclePlants->id }} @endsection

@section('content')

@component('components.breadcrumb')
@slot('li_1') Direct Vehicles & Plants @endslot
@slot('title') Direct Vehicles & Plants #{{ $directVehiclePlants->id }} @endslot
@endcomponent
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-6" style="text-align: right">
                        <h4 class="font-size-18 fw-bold">
                            <span class="ps-3">Direct Vehicles & Plants #{{ $directVehiclePlants->id }}</span>
                        </h4>
                    </div>
                </div>
                <div class="row col-md-12 pb-3">
                    <div class="col-sm-4">
                        ...
                        {{ $directVehiclePlants->vehicle_or_plant_name }}
                    </div>
                    <div class="col-sm-4">
                        <label class="form-label">Reference No</label><br>
                        {{ $directVehiclePlants->ref_no }}
                    </div>
                </div>
