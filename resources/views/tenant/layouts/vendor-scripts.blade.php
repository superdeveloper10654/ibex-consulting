...
<script>
    let conf = {{ AppTenant\Services\JSHelper::generateConf() }};
    let user_profile = {{ AppTenant\Services\JSHelper::generateUserProfileData() }};
</script>

<script src="{{ asset('assets/js/app-tenant.min.js') . '?v=' . filemtime(public_path('assets/js/app-tenant.min.js')) }}"></script>
